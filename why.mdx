...
2. **Evaluate** – Test contracts against agent traces offline
...
3. **Verify & Enforce** – Apply contracts during live execution
...
Ready to build more reliable AI agents? Start with our [Quick Start Guide](/quickstart) or explore [Core Concepts](/core-concepts) to learn more.
