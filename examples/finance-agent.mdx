...
We define the following two scenarios and corresponding Pathcondition and Postcondition requirements. 

Note that given that this agent is a single-turn agent with a fixed input, we do not need the Precondition.
...
$poetry run cli verify run cd26ad7e fin-agent-contract.json --timespan 1d
Verifying run cd26ad7e with specifications from .local/fin-agent-contract.json...
Output will be saved to output/verify_cd26ad7e.json
Contract Fin Scenarios: 100%|████████████████████████████████████████████████████████████████| 3/3 [00:05 < 00:00,  1.93s/it]
Contract Fin Scenarios: 100%|████████████████████████████████████████████████████████████████| 4/4 [00:07 < 00:00,  1.91s/it]
Contract Fin Scenarios: 100%|████████████████████████████████████████████████████████████████| 4/4 [00:08 < 00:00,  2.06s/it]
───────────────────────────────────────── Trace 150a4110d9de4134e577f7f4c0c56bd4 ──────────────────────────────────────────
                               Fin Scenarios (UNSATISFIED)
┏━━━━━━┳━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━┓
...
You can further inspect the detailed verification results with reasoning in the `output/verify_cd26ad7e.json` file.
